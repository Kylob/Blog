...
class BlogTest extends \BootPress\HTMLUnit\Component
{
    ...
    public function testCategorySimplePost()
    {
        ...
        $this->assertEqualsRegExp(array(
            ...
            '<article itemscope itemtype="http://schema.org/Article">',
                '<div class="page-header"><h1 itemprop="name">A Simple Post</h1></div>',
                '<p>',
                    'Published:',
                    '<a itemprop="datePublished" href="http://website.com/blog/archives/2010/08/03.html">August 3, 2010</a>',
                    'by <a itemprop="author" href="http://website.com/blog/authors/joe-bloggs.html">Joe Bloggs</a>',
                '</p>',
                ...
                '</div>',
                '<p>Tagged:',
                    '&nbsp;<a itemprop="keywords" href="http://website.com/blog/tags/simple.html">Simple</a>',
                    '&nbsp;<a itemprop="keywords" href="http://website.com/blog/tags/markdown.html">Markdown</a>',
                '</p>',
            '</article>',
            '<ul class="pager">',
    ...
    public function testCategorySubcategoryFeaturedPost()
    {
        ...
        $this->assertEqualsRegExp(array(
            '<ul class="breadcrumb">',
                '<li><a href="http://website.com/blog.html">Blog</a></li>',
                '<li><a href="http://website.com/category.html">Category</a></li>',
                '<li><a href="http://website.com/category/subcategory.html">Subcategory</a></li>',
                '<li class="active">&nbsp;</li>',
            '</ul>',
            '<article itemscope itemtype="http://schema.org/Article">',
                '<div class="page-header"><h1 itemprop="name">A Featured Post</h1></div>',
                '<p>',
                    'Published:',
                    '<a itemprop="datePublished" href="http://website.com/blog/archives/2010/09/12.html">September 12, 2010</a>',
                    'by <a itemprop="author" href="http://website.com/blog/authors/joe-bloggs.html">Joe Bloggs</a>',
                '</p>',
                '<div itemprop="articleBody" style="padding-bottom:40px;">',
                    '<ol>',
                ...
                '<p>Tagged:',
                    '&nbsp;<a itemprop="keywords" href="http://website.com/blog/tags/markdown.html">Markdown</a>',
                    '&nbsp;<a itemprop="keywords" href="http://website.com/blog/tags/featured.html">Featured</a>',
                '</p>',
            '</article>',
        ), static::$blog->theme->renderTwig($template));
        $this->assertEquals('blog-post.html.twig', $template['file']);
    ...
    public function testCategorySubcategoryFloweryPost()
    {
        ...
        $this->assertEqualsRegExp(array(
            ...
            '</ul>',
            '<article itemscope itemtype="http://schema.org/Article">',
                '<div class="page-header"><h1 itemprop="name">A Flowery Post</h1></div>',
                '<p>',
                    'Published:',
                    '<a itemprop="datePublished" href="http://website.com/blog/archives/2010/09/12.html">September 12, 2010</a>',
                '</p>',
                ...
                '</div>',
                '<p>Tagged:',
                    '&nbsp;<a itemprop="keywords" href="http://website.com/blog/tags/flowers.html">Flowers</a>',
                    '&nbsp;<a itemprop="keywords" href="http://website.com/blog/tags/nature.html">Nature</a>',
                '</p>',
            '</article>',
            '<ul class="pager">',
    ...
    public function testUncategorizedPost()
    {
        ...
        $this->assertEqualsRegExp(array(
            ...
            '</ul>',
            '<article itemscope itemtype="http://schema.org/Article">',
                '<div class="page-header"><h1 itemprop="name">Uncategorized Post</h1></div>',
                '<p>',
                    'Published:',
                    '<a itemprop="datePublished" href="http://website.com/blog/archives/2010/10/03.html">October 3, 2010</a>',
                '</p>',
                '<div itemprop="articleBody" style="padding-bottom:40px;">',
                    'A post without a category',
                '</div>',
    ...
    public function testBlogListings()
    {
        ...
        $this->assertEqualsRegExp(array(
            ...
            '<article itemscope itemtype="http://schema.org/Article">',
                '<h2 itemprop="name">',
                    '<a href="http://website.com/category/subcategory/featured-post.html">A Featured Post</a>',
                '</h2>',
                '<p>',
                    '<span itemprop="headline">OneTwoThree</span>',
                '</p>',
                '<a href="http://website.com/category/subcategory/featured-post.html">Read more &rarr;</a>',
            '</article>',
            '<article itemscope itemtype="http://schema.org/Article">',
                '<h2 itemprop="name">',
                    '<a href="http://website.com/uncategorized-post.html">Uncategorized Post</a>',
                '</h2>',
                '<p>',
                    '<span itemprop="headline">A post without a category</span>',
                '</p>',
                '<a href="http://website.com/uncategorized-post.html">Read more &rarr;</a>',
            '</article>',
            '<article itemscope itemtype="http://schema.org/Article">',
                '<h2 itemprop="name">',
                    '<a href="http://website.com/category/subcategory/flowery-post.html">A Flowery Post</a>',
                '</h2>',
                '<p>',
                    '<span itemprop="headline">A Flowery PostAren\'t they beautiful?</span>',
                '</p>',
                '<a href="http://website.com/category/subcategory/flowery-post.html">Read more &rarr;</a>',
            '</article>',
            '<article itemscope itemtype="http://schema.org/Article">',
                '<h2 itemprop="name">',
                    '<a href="http://website.com/category/simple-post.html">A Simple Post</a>',
                '</h2>',
                '<p>',
                    '<span itemprop="headline">HeaderParagraph</span>',
                '</p>',
                '<a href="http://website.com/category/simple-post.html">Read more &rarr;</a>',
            '</article>',
        ), static::$blog->theme->renderTwig($template));
    ...
    public function testBlogListingsSearch()
    {
        ...
        $this->assertEqualsRegExp(array(
            '<ul class="breadcrumb">',
                '<li><a href="http://website.com/blog.html">Blog</a></li>',
                '<li class="active">Search: &quot;simple post&quot;</li>',
            '</ul>',
            '<article itemscope itemtype="http://schema.org/Article">',
                '<h2 itemprop="name">',
                    '<a href="http://website.com/category/simple-post.html">A Simple Post</a>',
    ...
    public function testBlogCategoriesSearch()
    {
        ...
        $this->assertEqualsRegExp(array(
            '<ul class="breadcrumb">',
                '<li><a href="http://website.com/blog.html">Blog</a></li>',
                '<li><a href="http://website.com/category.html">Category</a></li>',
                '<li class="active">Search: beauty</li>',
            '</ul>',
            '<article itemscope itemtype="http://schema.org/Article">',
                '<h2 itemprop="name">',
                    '<a href="http://website.com/category/subcategory/flowery-post.html">A Flowery Post</a>',
    ...
    public function testArchivesListings()
    {
        ...
        $this->assertEqualsRegExp(array(
            ...
            '</ul>',
            '<h3><a href="http://website.com/blog/archives/2010.html">2010 <span class="label label-primary pull-right">4</span></a></h3>',
            '<div class="row" style="font-size:20px;">',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/01.html">Jan', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/02.html">Feb', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/03.html">Mar', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/04.html">Apr', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/05.html">May', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/06.html">Jun', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/07.html">Jul', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/08.html">Aug', '<br><span class="label label-primary">1</span>', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/09.html">Sep', '<br><span class="label label-primary">2</span>', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/10.html">Oct', '<br><span class="label label-primary">1</span>', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/11.html">Nov', '</a>', '</p>',
                '</div>',
                '<div class="col-xs-3 col-md-2 col-lg-1 center-block" style="height:100px;">',
                    '<p class="text-center">', '<a href="http://website.com/blog/archives/2010/12.html">Dec', '</a>', '</p>',
                '</div>',
            '</div>',
        ), static::$blog->theme->renderTwig($template));
    ...
    public function testThemeAddPageMethods()
    {
    ...
    public function testThemeMarkdownMethod()
    {
        ...
        $callable = function ($content) { return 'markdown'; };
        $this->assertNull(static::$blog->theme->markdown($callable));
        $this->assertEquals('markdown', static::$blog->theme->markdown('content'));
    }
    ...
    public function testThemeLayoutMethod()
    {
        ...
        $this->assertEquals('<strong>III</strong>', static::$blog->theme->layout('<strong>III</strong>'));
        ...
        $this->assertEqualsRegExp(array(
            'World War',
            '<strong>III</strong>',
        ), static::$blog->theme->layout('<strong>III</strong>'));
